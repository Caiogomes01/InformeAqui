...
<body class="antialiased">
        ...
        <div class="navbar">
            <nav class="navigation hide" id="navigation">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item"><a href="posters.php">Posters</a></li>
    ...
    <div class="container">
        <div class="subforum">
            ...
            <div class="subforum-row">
                <div class="subforum-icon subforum-column center">
                    <img src="img/processador" alt="Nome do Produto" style="width: 100px; height: 100px;">
                </div>
        ...
        <div class="subforum">
            ...
            <div class="subforum-row">
                <div class="subforum-icon subforum-column center">
                    <img src="img/placadevideo.jpg" alt="Nome do Produto" style="width: 100px; height: 100px;">
                </div>
                <div class="subforum-description subforum-column">
            ...
            <div class="subforum-row">
                <div class="subforum-icon subforum-column center">
                    <img src="img/memoriaram.jpg" alt="Nome do Produto" style="width: 100px; height: 100px;">
                </div>
                <div class="subforum-description subforum-column">
            ...
            <div class="subforum-row">
                <div class="subforum-icon subforum-column center">
                    <img src="img/Placamae.jpg" alt="Nome do Produto" style="width: 100px; height: 100px;">
                </div>
                <div class="subforum-description subforum-column">
            ...
            <div class="subforum-row">
                <div class="subforum-icon subforum-column center">
                    <img src="img/nv2.jpg" alt="Nome do Produto" style="width: 100px; height: 100px;">
                </div>
                <div class="subforum-description subforum-column">
            ...
            <div class="subforum-row">
                <div class="subforum-icon subforum-column center">
                    <img src="img/fonte_msi_650w.jpg" alt="Nome do Produto" style="width: 100px; height: 100px;">
                </div>
                <div class="subforum-description subforum-column">
